...
module.exports = {
    platform: "波点",
    author: '猫头猫 & 梓澄 & Thomas喲',
    version: "0.1.8",
    appVersion: ">0.1.0-alpha.0",
    srcUrl: "https://gitee.com/ThomasYou/musicfree/raw/master/dist/kw/index.js",
    ...
    async getMediaSource(musicItem, quality) {
        ...
        // 接口来源：https://github.com/lxmusics/lx-music-api-server
        const res = (await axios_1.default.get("https://bd-api.kuwo.cn/api/service/music/downloadInfo/" + musicItem.id, {
            params: {
                'isMv': '0',
                'format': f,
                'br': b,
