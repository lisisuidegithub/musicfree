...
function formatMusicItem(_) {
    ...
    return {
        ...
        url: `https://api.cenguigui.cn/api/api.php?id=${_.id}&musictype=exhigh`,
        qualities: {
            low: {
                size: (_a = (_.l || _.m||{})) === null || _a === void 0 ? void 0 : _a.size,
            },
            standard: {
                size: (_b = (_.h || {})) === null || _b === void 0 ? void 0 : _b.size,
            },
            high: {
                size: (_c = (_.sq || {})) === null || _c === void 0 ? void 0 : _c.size,
            },
            super: {
                size: (_d = (_.hr || {})) === null || _d === void 0 ? void 0 : _d.size,
            },
        },
...
async function getMediaSource(musicItem, quality) {
    return {
        url: `https://api.cenguigui.cn/api/api.php?id=${musicItem.id}&musictype=${quality}`
    };
}
const headers = {
    authority: "music.163.com",
